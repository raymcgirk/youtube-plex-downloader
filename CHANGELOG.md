...
- **Fixed special character issues** in filenames by using `sanitize_filename()`.  
...
- **Logs now auto-delete after 30 days, ensuring long-term log management without manual cleanup.**
